    ...
    return (
        <DivStyled>
            ...
            <PhoneNameDiv>
                ...
                <ButtonPhone>
                <Button backgroundColor={'#9292EF'} height={'65px'}  color={'#FFF'} width={'232px'}>В корзину</Button>
                <Button backgroundColor={'#FFFFFF'} height={'65px'} width={'232px'} border={' 2px solid #9292EF'}>Купить сейчас</Button>
                </ButtonPhone>
            </PhoneNameDiv>
        </DivStyled>
    )
